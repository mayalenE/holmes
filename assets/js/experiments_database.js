        ...
        $(document).ready(function(){
            $.getJSON( "https://mayalenE.github.io/holmes/assets/media/experiments/experiment_names.json", function( data ) {
                var items = [];
            ...
            $("#load_images").submit(function(){
                ...
                $.getJSON("https://mayalenE.github.io/holmes/assets/media/experiments/"+ $("#experiment").val() +  "/repetition_" + pad( $("#repetition").val(),6) +"/classes.json", function( data ) {
        ...
        function displayImagesWithClassFromNumber(start_from_image, image_map_for_class){
            ...
            for(i = 1; i <= 48; i++){
                ...
                $("#img_"+(i-1)+" img").attr('src',"https://mayalenE.github.io/holmes/assets/media/experiments/"+ $("#experiment").val() +  "/repetition_" + pad( $("#repetition").val(),6) +"/images/" +  (image_number)  +".png");
