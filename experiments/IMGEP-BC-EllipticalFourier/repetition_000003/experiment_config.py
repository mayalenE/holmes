...
def get_model_config(model_name):
    ...
    if 'network' in model_config:
        ...
        if "ProgressiveTree" in model_name:
            ...
            model_config.node.network.name = ""
            model_config.node.network.parameters = {}
            model_config.node.create_connections = {}

            model_config.network.parameters = {}
            ...
            ## network
            model_config.network.name = ""
            model_config.network.parameters = {}

        ## initialization
        model_config.network.initialization.name = ""
        model_config.network.initialization.parameters =  {}

        ## loss
        model_config.loss.name = ""
        model_config.loss.parameters = {}

        ## optimizer
        model_config.optimizer.name = ""
        model_config.optimizer.parameters = {}
...
def get_explorer_config():
    ...
    explorer_config.visual_representation.model.name = "BCEllipticalFourier"
