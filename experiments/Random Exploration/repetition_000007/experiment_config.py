...
def get_model_config(model_name):
    ...
    if 'network' in model_config:
        ...
        if "ProgressiveTree" in model_name:
            ...
            model_config.node_classname = ""
            model_config.node.network.name = "Burgess"
            model_config.node.network.parameters = {"n_channels": 1, "input_size": (256,256), "n_latents": 16, "n_conv_layers": 6, "hidden_channels": 32, "hidden_dim": 256, "encoder_conditional_type": "gaussian", "feature_layer": 2}
            model_config.node.create_connections = {}

            model_config.network.parameters = {"n_channels": 1, "input_size": (256,256), "n_latents": 16, "n_conv_layers": 6, "hidden_channels": 32, "hidden_dim": 256, "encoder_conditional_type": "gaussian", "feature_layer": 2}
...
def get_explorer_config():
    ...
    explorer_config.visual_representation.seed = 7
    explorer_config.visual_representation.training.output_folder = "./training"
    explorer_config.visual_representation.model.name = "VAE"
    ...
    explorer_config.progressive_training.n_runs_between_stages = 5000
    explorer_config.progressive_training.n_epochs_per_stage = 0
    explorer_config.progressive_training.train_batch_size = 128
    explorer_config.progressive_training.importance_sampling_new_vs_old = 0
    explorer_config.progressive_training.alternated_backward = {}
