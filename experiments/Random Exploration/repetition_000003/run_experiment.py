...
def run_exploration():
    ...
    system = ad.systems.Lenia(system_parameters=experiment_config.get_system_parameters(), config = experiment_config.get_system_config())
    system.statistics.append(ad.systems.lenia.LeniaClassifierStatistics())
    explorer = ad.explorers.ProgressiveExplorer(system=system, config=experiment_config.get_explorer_config())
